...
_MESSAGEOFTYPES_MAPSTRINGSTRINGENTRY = _descriptor.Descriptor(
  name='MapStringStringEntry',
  full_name='tests.MessageOfTypes.MapStringStringEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='tests.MessageOfTypes.MapStringStringEntry.key', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='tests.MessageOfTypes.MapStringStringEntry.value', index=1,
...
_MESSAGEOFTYPES = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mapStringString', full_name='tests.MessageOfTypes.mapStringString', index=20,
  ...
  nested_types=[_MESSAGEOFTYPES_MAPSTRINGSTRINGENTRY, _MESSAGEOFTYPES_NESTEDTYPE, ],
  enum_types=[
...
_MESSAGEOFTYPES_MAPSTRINGSTRINGENTRY.containing_type = _MESSAGEOFTYPES
...
_MESSAGEOFTYPES.fields_by_name['mapStringString'].message_type = _MESSAGEOFTYPES_MAPSTRINGSTRINGENTRY
...
MessageOfTypes = _reflection.GeneratedProtocolMessageType('MessageOfTypes', (_message.Message,), dict(
  ...
  MapStringStringEntry = _reflection.GeneratedProtocolMessageType('MapStringStringEntry', (_message.Message,), dict(
    DESCRIPTOR = _MESSAGEOFTYPES_MAPSTRINGSTRINGENTRY,
    __module__ = 'tests.sample_pb2'
    # @@protoc_insertion_point(class_scope:tests.MessageOfTypes.MapStringStringEntry)
    ))
  ,
...
_sym_db.RegisterMessage(MessageOfTypes.MapStringStringEntry)
...
_MESSAGEOFTYPES_MAPSTRINGSTRINGENTRY.has_options = True
_MESSAGEOFTYPES_MAPSTRINGSTRINGENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
